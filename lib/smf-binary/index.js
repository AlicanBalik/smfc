...
function create(data, callback) {
	...
	if (data.iosConfig) {
		data.iosConfig.config2.fileVersion = playerSpecific.RUNTIME_VERSION;
		data.iosConfig.sasVersion = data.PLAYER_VERSION;
	} else if (data.androidConfig) {
		data.androidConfig.config2.fileVersion = playerSpecific.RUNTIME_VERSION;
	}
